...
using IndexCRM.Admin.Web;

namespace IndexCRM.Admin.Emailing
{
    public class EmailTemplateProvider : IEmailTemplateProvider, ITransientDependency
    {
        ...
        {
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("IndexCRM.Admin.Emailing.EmailTemplates.default.html"))
            {
