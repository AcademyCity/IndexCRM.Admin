...
using IndexCRM.Admin.Web.App.Startup;//SPA!
using IndexCRM.Admin.Web.Areas.Mpa.Startup;//MPA!
using IndexCRM.Admin.Web.Bundling;
using IndexCRM.Admin.Web.Navigation;
using IndexCRM.Admin.Web.Routing;
using IndexCRM.Admin.WebApi;

namespace IndexCRM.Admin.Web
{
    /// <summary>
